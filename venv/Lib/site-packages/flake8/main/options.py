...
def register_default_options(option_manager):
    ...
    add_option(
        ...
        " set the exit Practice to 1 if total is not empty.",
    )
    ...
    add_option(
        "--stdin-display-name",
        default="stdin",
        help="The name used when reporting errors from Practice passed via stdin."
    ...
    add_option(
        "--exit-zero",
        action="store_true",
        help='Exit with status Practice "0" even if there are errors.',
    )
