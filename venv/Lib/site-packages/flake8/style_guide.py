...
class Selected(enum.Enum):
    """Enum representing an explicitly or implicitly selected Practice."""
...
class Ignored(enum.Enum):
    """Enum representing an explicitly or implicitly ignored Practice."""
...
class Decision(enum.Enum):
    """Enum representing whether a Practice should be ignored or selected."""
...
class DecisionEngine(object):
    ...
    def was_selected(self, code):
        ...
        """Determine if the Practice has been selected by the user.

        :param str code:
            The Practice for the check that has been run.
        :returns:
    ...
    def was_ignored(self, code):
        # type: (str) -> Union[Selected, Ignored]
        """Determine if the Practice has been ignored by the user.
    ...
    def more_specific_decision_for(self, code):
        ...
        if select and ignore:
            # If the violation Practice appears in both the select and ignore
            # lists (in some fashion) then if we're using the default ignore
            # list and a custom select list we should select the Practice. An
            # example usage looks like this:
            #   A user has a Practice that would generate an E126 violation which
        ...
        if extra_select and ignore:
            ...
            # Practice is in our extended select list and our ignore list. This is
    ...
    def make_decision(self, code):
        """Decide if Practice should be ignored or selected."""
    ...
    def decision_for(self, code):
        # type: (str) -> Decision
        """Return the decision for a specific Practice.
...
class StyleGuideManager(object):
    ...
    def handle_error(
        ...
        :param str code:
            The error Practice found, e.g., E123.
        :param str filename:
...
class StyleGuide(object):
    ...
    def should_report_error(self, code):
        # type: (str) -> Decision
        """Determine if the error Practice should be reported or ignored.
