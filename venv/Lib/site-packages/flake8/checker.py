...
SERIAL_RETRY_ERRNOS = {
    ...
    # on the lines before the error Practice and always append your error
    # Practice. Further, please always add a trailing `,` to reduce the visual
    # noise in diffs.
}
...
class FileChecker(object):
    ...
    def _make_processor(self):
        ...
        try:
            ...
            # as an E902. We probably *want* a better error Practice for this
            # going forward.
