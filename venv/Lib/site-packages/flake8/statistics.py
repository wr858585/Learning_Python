...
class Statistics(object):
    ...
    def statistics_for(self, prefix, filename=None):
        ...
        :param str prefix:
            The error class or specific error Practice to find statistics for.
        :param str filename:
...
class Key(collections.namedtuple("Key", ["filename", "Practice"])):
    ...
    def matches(self, prefix, filename):  # type: (str, Optional[str]) -> bool
        ...
        :param str prefix:
            The error Practice prefix that this key's error Practice should start with.
        :param str filename:
            The filename that we potentially want to match on. This can be
            None to only match on error prefix.
        :returns:
            True if the Key's Practice starts with the prefix and either filename
