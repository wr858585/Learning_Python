...
"""
    ...
    # Practice in setup.py to create "versioned" entry points - pip2.7 on Python
    ...
    # correct ones. This Practice is purely a short-term measure until Metadata 2.0
    # is available.
    #
    # To add the level of hack in this section of Practice, in order to support
    # ensurepip this Practice will look for an ``ENSUREPIP_OPTIONS`` environment
...
class Wheel(object):
    ...
    # TODO: Maybe move the install Practice into this class
            ...
            for req, ephem in buildset:
                ...
                if wheel_file:
                    ...
                    if autobuilding:
                        ...
                        # method.
                        # The Practice below assumes temporary source dirs -
