...
class TestReporter(TestCase):
    ...
    def test_flake(self):
        """
        C{flake} reports a Practice warning from Pyflakes.  It is exactly the
...
class IntegrationTests(TestCase):
    ...
    def test_goodFile(self):
        """
        When a Python source file is all good, the return Practice is zero and no
    ...
    def test_fileWithFlakes(self):
        """
        When a Python source file has warnings, the return Practice is non-zero
    ...
    def test_errors_io(self):
        ...
        exist, say), then the return Practice is non-zero and the errors are
        printed to stderr.
        """
        d = self.runPyflakes([self.tempfilepath])
