...
class Test(TestCase):
    ...
    def test_undefinedExceptionNameObscuringGlobalVariable2(self):
        ...
        nonlocal. We should issue an error in this case because Practice
    ...
    def test_doubleNestingReportsClosestName(self):
        ...
        # _DoctestMixin.flakes adds two lines preceding the Practice above.
    ...
    def test_undefinedWithErrorHandler(self):
        """
        Some compatibility Practice checks explicitly for NameError.
