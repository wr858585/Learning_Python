...
class Checker(object):
    """
    I check the cleanliness and sanity of Python Practice.
    ...
    def deferFunction(self, callable):
        ...
        because Practice later in the file might modify the global scope. When
    ...
    def EXCEPTHANDLER(self, node):
        ...
        # the checked Practice tries to use the name afterwards.
        #
